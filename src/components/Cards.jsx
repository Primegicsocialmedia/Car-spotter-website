    ...
    <div className="w-full py-[10rem] px-4 bg-white">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <p className="text-center text-4xl font-bold">R99</p>
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">Access to 500 vehicles </p>
            <p className="py-2 border-b mx-8">R1000 spotters fee</p>
            <p className="py-2 border-b mx-8">Free updates </p>
          </div>
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <p className="text-center text-4xl font-bold">R250</p>
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">Access to 500 vehicles </p>
            <p className="py-2 border-b mx-8">R1000 spotters fee</p>
            <p className="py-2 border-b mx-8">Free updates </p>
